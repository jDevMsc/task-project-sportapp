...
public class MealTestData {
    ...
    public static final UserMeal MEAL1 = new UserMeal(MEAL1_ID, LocalDateTime
        .of(2015, Month.MAY, 30, 10, 0), "Завтрак", 500);
    ...
    public static final List<UserMeal> USER_MEALS = Arrays
        .asList(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1);
